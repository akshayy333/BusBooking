...
<body>
	...
	<div>
		<label class="h2" style="margin-left: 41.5%; color:white">BUS DETAILS</label><a
			id="lgbtn" class="btn btn-danger" type="button"
			href="<%=request.getContextPath()%>/Logout?page=Booking">Logout</a>
	</div>
	<div class="scroll">
	...
	<div class="card">
		<div class="form-group">
			<form name="bform" action="Bookingcheck"
			...
			<label for="not">No Of Tickets</label> <input name="notbtn"
				id="notbtn" class="btn btn-primary" type="button" value="Submit">
	...
	<script>
		function validateform() {
			var k = document.forms["bform"]["bid"].value;
			if (k == "") {
