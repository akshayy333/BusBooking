...
body {
	...
	font-family: italic;
	background-image: url(https://c4.wallpaperflare.com/wallpaper/128/349/160/street-car-road-city-wallpaper-preview.jpg);
...
<body>
	<form name="sform" action="Agentcheck" method="post"
