...
body {
	...
	background-image:
		url(https://c4.wallpaperflare.com/wallpaper/137/42/530/monsters-bus-chernobyl-pripyat-art-hd-wallpaper-preview.jpg);
}
...
<body>
	<div>
		<label class="h2" style="margin-left: 41.5%;">BUS DETAILS</label><a
			href="<%=request.getContextPath()%>/Logout?page=Bookingpage3"
			id="lgbtn" class="btn btn-danger" type="button">Logout</a>
	</div>
	<div class="scroll">
	...
	<div class="card">
		<div class="form-group">
			<form name="bg2form" action="Bookingcheck"
			...
			<form name="tickform" action="Ticketscheck"
				onsubmit="return validateform1()" method="get">
				...
				<div>
					<a style="margin-left: 200px; margin-top: 30px; width: 30%;"
						id="cnfrm" class="btn btn-primary" type="button"
						href="<%=request.getContextPath()%>/Confirmation?conpage=Bookingpage3">Click
						to Confirm Tickets</a>
					<p id="tcblock">
						Ticket Price -->
						<%=request.getAttribute("tktprice")%><br>No.Of.Tickets -->
						<%=request.getAttribute("not")%><br>Total Fare --> Rs.<%=request.getAttribute("totalfare")%></p>
				</div>
			</form>
		</div>
	</div>
